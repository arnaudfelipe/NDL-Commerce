...
public class BrandRegisterInteractor implements BrandInputBoundary {
  ...
  @Override
  public BrandResponseDTO getById(UUID brandId) {
  ...
  @Override
  public BrandResponseDTO update(UUID brandId, BrandRequestDTO requestDTO) {
    Optional<BrandDataMapper> optional = brandDsGateway.getById(brandId);
    ...
    if (brandDsGateway.existsByNameAndNotId(requestDTO.name(), brandId)) {
      return brandPresenter.prepareFailView("ExistByName");
    }
    ...
    BrandDataMapper updated = brandDsGateway.update(brandId, request);

    return brandPresenter.prepareSuccessView(mapperToDTO(updated));
  }

  @Override
  public Object delete(UUID brandId) {
    Optional<BrandDataMapper> optional = brandDsGateway.getById(brandId);
